...
const EmptyLastActiveModal = ({ isOpen, onClose }) => (
  <Modal
    isOpen={isOpen}
    onClose={onClose}
    hideHeader
  ...
  >
    <S.ModalEmpty>
      ...
      <S.ModalEmptyColumn>
        ...
        <span>Are you sure to empty last active operators? The list of last operators in the chatbox will be cleaned.</span>
      </S.ModalEmptyColumn>
    </S.ModalEmpty>
  </Modal>
);
