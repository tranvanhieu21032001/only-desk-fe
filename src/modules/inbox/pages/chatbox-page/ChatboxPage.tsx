...
import { ChatboxMenus } from '@/modules/settings/components/chatbox';
                    ...
                    <>
                        ...
                        <S.ShortcutBox>
                            <S.ShortcutEmpty>
                                ...
                                <S.ShortcutDesc>Your shortcuts will appear here.</S.ShortcutDesc>
                            </S.ShortcutEmpty>
                    ...
                    <S.ShortcutBox>
                        <S.ShortcutEmpty>
                            <S.ShortcutText style={{ fontSize: 20, fontWeight: 700 }}>
                                {type.replace(/-/g, ' ').replace(/\b\w/g, c => c.toUpperCase())} UI Placeholder
                            </S.ShortcutText>
                            <S.ShortcutDesc>This is the UI for "{type}". Update this section as needed.</S.ShortcutDesc>
                        </S.ShortcutEmpty>
                    </S.ShortcutBox>
                )}
            </S.ChatboxContent>
