import { CardPluginInterface, CategoriesInterface, PluginsTypeInterface } from "../../model/allPlugins"
...
const mockupCardPlugins: CardPluginInterface[] = [
    ...
    },
    {
        key: "salesforce",
        name: "Salesforce",
        description: "Sync your contacts between Salesforce and OnlyChat automatically.",
