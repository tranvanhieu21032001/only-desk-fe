...
export const SOCKET_RECEIVE_EVENT_SERVER_TYPING = "server_is_typing";
...
export const SOCKET_SEND_EVENT_TYPING_STOP = "typing_stop";
export const SOCKET_SEND_EVENT_OPEN_CONVERSATION = "open_conversation";
export const SOCKET_SEND_EVENT_CLOSE_CONVERSATION = "close_conversation";
export const SOCKET_SEND_EVENT_GUEST_SUBMIT_INPUT = "guest_submit_input";
